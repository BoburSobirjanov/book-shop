...
import uz.com.bookshop.filter.FilterToken;
import uz.com.bookshop.service.auth.AuthenticationService;
...
public class SecurityConfig {
    ...
    CorsConfigurationSource corsConfigurationSource(){
        ...
        corsConfiguration.setAllowedOrigins(List.of("http://locahost:8082/api/v1", "*"));
